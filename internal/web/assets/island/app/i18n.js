...
export const I18N = {
  en: {
    ...
    dialPlaceholder: "Number or extension",
    call: "Call",
    hold: "Hold",
    resume: "Resume",
    focus: "Focus",
    ...
    regRebuilding: "rebuilding connection…",
    onHold: "on hold",
    inCall: "in call",
    calling: "calling…",
    ringing: "ringing…",
  ...
  de: {
    ...
    dialPlaceholder: "Nummer oder Durchwahl",
    call: "Anrufen",
    hold: "Halten",
    resume: "Fortsetzen",
    focus: "Aktivieren",
    ...
    regRebuilding: "Verbindung wird neu aufgebaut…",
    onHold: "gehalten",
    inCall: "im Gespräch",
